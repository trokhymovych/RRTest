...
from knowledge_integrity.models.revertrisk import classify, load_model
from knowledge_integrity.revision import get_current_revision
from tqdm import tqdm

model_path = 'pretrained_models/revertrisk_model_v1.pkl'
...
filename = 'data/RRLA_results.data'
